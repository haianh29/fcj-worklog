...
1. **[System & Workshop Overview](5.1-Workshop-overview/)** - business context of the IMS system and how the hands-on lab is organized.
2. **[Solution Architecture & IaC](5.2-architecture-iac/)** - overall IMS architecture on AWS and (optional) infrastructure-as-code.
3. **[VPC & Networking](5.3%20vpc-networking/)** - VPC, subnets, routing, Internet/NAT gateways, security groups, and connectivity to AWS services.
